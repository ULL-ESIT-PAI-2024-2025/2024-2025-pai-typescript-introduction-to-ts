 ...
 *       In this file you will find a bad interface extension example.
 *
 */
...
interface AddressWithUnit extends BasicAddress {
  city: number; // Same property name but different type
  unit: string;
}
...
interface Person {
  name: number; // Same property name but different type
}
